...
public class OptionsFormatException extends Exception {
	 ...
	 * 
	 * @param option
	 *            Une option a laquelle on a passe un nombre d'argument
	 *            incorrect
	 * @param nb_arg
	 *            Le nombre d'argument que prend cette option
	 */
	public OptionsFormatException(String option, int nb_arg) {
		super("L'option " + option + " prend " + nb_arg
				+ " arguments en parametre.");
	}
}
